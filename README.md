...
The dashboard at `http://localhost:4100/` lists all mounted extensions with links. `GET /api` returns a JSON listing of API mounts.
...
- `/api` returns a JSON listing of API mounts (token auth)
